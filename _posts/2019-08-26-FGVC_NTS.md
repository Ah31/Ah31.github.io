...
![_config.yml]({{ site.baseurl }}/images/config.png "NTS Model Architecture")
...
![_config.yml]({{ site.baseurl }}/images/config.png "TOP 3 most informative regions learned by NTS (dataset used for training:-FGVC Aircraft)")

![_config.yml]({{ site.baseurl }}/images/config.png "TOP 2 most informative regions learned by NTS (dataset used for training:-Stanford-Cars)")
